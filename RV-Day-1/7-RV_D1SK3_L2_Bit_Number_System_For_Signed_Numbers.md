...
Unsigned numbers can only represent positive values and zero.
However, real-world computations also require negative numbers.

Examples subtraction, temperature values, offsets, memory addressing and arithmetic computations.Therefore, processors require signed number representation.
